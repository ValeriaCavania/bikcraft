...
function formularioEnviado(resposta) {
    if (resposta.ok) {
        ...
        formulario.innerHTML = "<p class='font-2-l' style='grid-column: 1/-1; padding: 1rem; border-radius: 4px; background: #e00000;'><span style= 'color: #e00000;'>Erro no envio</span>, você pode enviar diretamente para o nosso email em: contato@bikcraft.net<p>";
    }
}
...
function enviarFormulario(event) {
    ...
    fetch('./enviar.php', { //funcao que recebe a url da qual se envia dados e objetos com as propriedades, method sendo post.
        method: 'POST',
        body: data,
